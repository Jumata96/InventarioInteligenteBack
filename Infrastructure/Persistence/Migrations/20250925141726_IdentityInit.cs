        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("CK_Productos_Precio_Positive", "[Precio] > 0");
                    table.CheckConstraint("CK_Productos_Stock_NonNegative", "[Stock] >= 0");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ReglasDescuento", x => x.ReglaId);
                    table.CheckConstraint("CK_Reglas_Tipo", "[Tipo] IN ('Porcentaje','Fijo')");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Impuestos_Paises_PaisId",
                        column: x => x.PaisId,
                        principalTable: "Paises",
                        principalColumn: "PaisId");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("CK_Detalles_Cantidad_Positive", "[Cantidad] > 0");
                    table.CheckConstraint("CK_Detalles_PrecioUnitario_Positive", "[PrecioUnitario] > 0");
                    table.ForeignKey(
